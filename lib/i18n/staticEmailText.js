...
const STATIC_EMAIL_LABELS = {
  sv: {
    ...
    "emails.planActivated.eyebrow": "Plan klar",
    ...
    "emails.planActivated.button": "Visa planen i Spreelo",
    ...
    "emails.analysisCompleted.subject": "Din varumärkesanalys och kampanjkalender är klara · {brand}",
    "emails.analysisCompleted.eyebrow": "Varumärkesprofil och kalender klara",
    "emails.analysisCompleted.title": "Din analys och personliga kalender är klara",
    "emails.analysisCompleted.intro": "Spreelo har slutfört varumärkesanalysen för {brand}. Din varumärkesprofil och personliga kampanjkalender är nu klara att använda.",
    ...
    "emails.failedRefunded.subject": "Ett planerat inlägg kunde inte slutföras · {brand}",
    "emails.failedRefunded.eyebrow": "Planerat inlägg avbrutet",
    "emails.failedRefunded.title": "Vi kunde inte slutföra ett planerat inlägg",
    "emails.failedRefunded.intro": "Spreelo kunde inte slutföra det planerade inlägget {postType} för {brand}, trots att det hölls kvar för extra granskning.",
    "emails.failedRefunded.reasonLabel": "Vad som hände",
    "emails.failedRefunded.reasonWebsite": "Webbplatsen gav inte tillräckligt med åtkomlig och verifierbar produkt- eller företagsinformation för att Spreelo skulle kunna skapa inlägget på ett säkert sätt.",
    "emails.failedRefunded.reasonProduct": "Spreelo kunde inte verifiera en lämplig produkt och dess tillhörande bild tillräckligt säkert för att skapa inlägget.",
    "emails.failedRefunded.reasonMedia": "Bild- eller videogenereringen kunde inte slutföras enligt Spreelos krav på kvalitet och verifiering.",
    "emails.failedRefunded.reasonTechnical": "Ett tekniskt beroende gjorde att Spreelo inte kunde slutföra inlägget på ett tillförlitligt sätt.",
    "emails.failedRefunded.refund": "{credits} kredit(er) har återbetalats till ditt Spreelo-saldo.",
    "emails.failedRefunded.nextTitle": "Ditt övriga planerade innehåll kan fortsätta",
    "emails.failedRefunded.nextText": "Det avbrutna inlägget kommer inte att försöka skapas igen. Övriga aktiva planer och framtida inlägg påverkas inte, om inte Spreelo separat har pausat en plan som behöver åtgärdas.",
    "emails.failedRefunded.button": "Öppna Spreelo",
    "emails.failedRefunded.security": "Det här är ett servicemeddelande om ett planerat Spreelo-inlägg. Du behöver inte svara på mejlet.",
    "emails.trialEnding.subject": "Din Spreelo-provperiod slutar snart",
    "emails.trialEnding.title": "3 dagar kvar av din provperiod",
    "emails.trialEnding.text": "Din gratis provperiod slutar {date}. Därefter börjar den plan du valde att debiteras automatiskt. Du kan ändra eller avsluta prenumerationen i Spreelo-inställningarna.",
    "emails.trialEnding.soon": "snart",
    "emails.trialEnding.button": "Hantera prenumeration",
  },
  da: {
    "emails.planActivated.subject": "Din marketingplan i Spreelo er klar · {brand}",
    "emails.planActivated.eyebrow": "Planen er klar",
    ...
    "emails.planActivated.button": "Se planen i Spreelo",
    ...
    "emails.failedRefunded.subject": "Et planlagt opslag kunne ikke færdiggøres · {brand}",
    "emails.failedRefunded.eyebrow": "Planlagt opslag annulleret",
    "emails.failedRefunded.title": "Vi kunne ikke færdiggøre et planlagt opslag",
    "emails.failedRefunded.intro": "Spreelo kunne ikke færdiggøre det planlagte {postType}-opslag for {brand}, selv efter ekstra gennemgang.",
    "emails.failedRefunded.reasonLabel": "Hvad skete der",
    "emails.failedRefunded.reasonWebsite": "Webstedet gav ikke nok tilgængelige og verificerbare produkt- eller virksomhedsoplysninger til, at Spreelo kunne oprette opslaget sikkert.",
    "emails.failedRefunded.reasonProduct": "Spreelo kunne ikke verificere et passende produkt og det tilhørende billede sikkert nok til at oprette opslaget.",
    "emails.failedRefunded.reasonMedia": "Billed- eller videogenereringen kunne ikke færdiggøres efter Spreelos krav til kvalitet og verificering.",
    "emails.failedRefunded.reasonTechnical": "En teknisk afhængighed forhindrede Spreelo i at færdiggøre opslaget pålideligt.",
    "emails.failedRefunded.refund": "{credits} kredit(ter) er tilbageført til din Spreelo-saldo.",
    "emails.failedRefunded.nextTitle": "Dit øvrige planlagte indhold kan fortsætte",
    "emails.failedRefunded.nextText": "Det annullerede opslag forsøges ikke igen. Andre aktive planer og fremtidige opslag påvirkes ikke, medmindre Spreelo separat har sat en plan på pause, fordi den kræver handling.",
    "emails.failedRefunded.button": "Åbn Spreelo",
    "emails.failedRefunded.security": "Dette er en servicemeddelelse om et planlagt Spreelo-opslag. Du behøver ikke svare på e-mailen.",
    "emails.trialEnding.subject": "Din Spreelo-prøveperiode slutter snart",
    "emails.trialEnding.title": "3 dage tilbage af din prøveperiode",
    "emails.trialEnding.text": "Din gratis prøveperiode slutter {date}. Derefter begynder den valgte plan automatisk at blive faktureret. Du kan ændre eller opsige abonnementet i Spreelo-indstillingerne.",
    "emails.trialEnding.soon": "snart",
    "emails.trialEnding.button": "Administrer abonnement",
  },
  no: {
    ...
    "emails.failedRefunded.subject": "Et planlagt innlegg kunne ikke fullføres · {brand}",
    "emails.failedRefunded.eyebrow": "Planlagt innlegg avbrutt",
    "emails.failedRefunded.title": "Vi kunne ikke fullføre et planlagt innlegg",
    "emails.failedRefunded.intro": "Spreelo kunne ikke fullføre det planlagte {postType}-innlegget for {brand}, selv etter ekstra gjennomgang.",
    "emails.failedRefunded.reasonLabel": "Hva skjedde",
    "emails.failedRefunded.reasonWebsite": "Nettstedet ga ikke nok tilgjengelig og verifiserbar produkt- eller bedriftsinformasjon til at Spreelo kunne opprette innlegget på en trygg måte.",
    "emails.failedRefunded.reasonProduct": "Spreelo kunne ikke verifisere et egnet produkt og tilhørende bilde sikkert nok til å opprette innlegget.",
    "emails.failedRefunded.reasonMedia": "Bilde- eller videogenereringen kunne ikke fullføres etter Spreelos krav til kvalitet og verifisering.",
    "emails.failedRefunded.reasonTechnical": "En teknisk avhengighet hindret Spreelo i å fullføre innlegget pålitelig.",
    "emails.failedRefunded.refund": "{credits} kreditt(er) er tilbakeført til Spreelo-saldoen din.",
    "emails.failedRefunded.nextTitle": "Det øvrige planlagte innholdet ditt kan fortsette",
    "emails.failedRefunded.nextText": "Det avbrutte innlegget blir ikke forsøkt opprettet igjen. Andre aktive planer og fremtidige innlegg påvirkes ikke, med mindre Spreelo separat har satt en plan på pause fordi den krever handling.",
    "emails.failedRefunded.button": "Åpne Spreelo",
    "emails.failedRefunded.security": "Dette er en servicemelding om et planlagt Spreelo-innlegg. Du trenger ikke svare på e-posten.",
    "emails.trialEnding.subject": "Spreelo-prøveperioden din slutter snart",
    "emails.trialEnding.title": "3 dager igjen av prøveperioden",
    "emails.trialEnding.text": "Den gratis prøveperioden din slutter {date}. Deretter begynner planen du valgte å bli fakturert automatisk. Du kan endre eller avslutte abonnementet i Spreelo-innstillingene.",
    "emails.trialEnding.soon": "snart",
    "emails.trialEnding.button": "Administrer abonnement",
  },
};
