...
function buildEmailHtml({ eyebrow, title, intro, highlights, nextTitle, nextText, button, buttonUrl, security }) {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="padding:34px 14px;background:#f2eee8"><tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:650px;border:1px solid #e3d8d0;border-radius:22px;overflow:hidden;background:#fffdfa;box-shadow:0 16px 48px rgba(29,37,48,.10)">
      <tr><td style="padding:32px 32px 27px;background:linear-gradient(135deg,#0b1c2c,#153c58);color:#fff">
      ...
      <tr><td style="padding:25px 32px 28px">
      ...
      <tr><td style="padding:18px 32px;background:#fff7f1;border-top:1px solid #efe1d8;color:#786b64;font-size:12px;line-height:1.65">${escapeHtml(security)}</td></tr>
    </table>
