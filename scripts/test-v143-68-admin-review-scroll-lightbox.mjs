...
expect(page.includes('admin-review-jump-products') && page.includes('admin.approvals.editProducts'), 'Admin must expose a visible Edit products jump action.');
expect(page.includes('admin.approvals.replaceProductUrl') && page.includes('admin.approvals.productRefreshHelp'), 'Product replacement workflow must be explicit in the review UI.');
